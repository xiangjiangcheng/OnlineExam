...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">添加学生用户</h1>
                    <h1 class="page-subhead-line">下面请进行准确填写学生信息，进行添加操作. </h1>
                </div>
            </div>
            <!-- /. ROW  -->
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-info">
                        ...
                        <form:form action="/students/student/addP" method="post" commandName="student" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="snumber" name="snumber" placeholder="输入学号:"/>
                            </div>
                            <div class="form-group">
                                <label for="smail">邮箱:</label>
                                <input type="text" class="form-control" id="smail" name="smail" placeholder="输入邮箱:"/>
                            </div>
                            <div class="form-group">
                                <label for="spwd">密码:</label>
                                <input type="text" class="form-control" id="spwd" name="spwd" placeholder="输入密码:"/>
                            </div>
                            <div class="form-group">
                                <label for="saddress">地址:</label>
                                <input type="text" class="form-control" id="saddress" name="saddress" placeholder="输入地址:"/>
                            </div>
                            <div class="form-group">
                                <label for="stel">电话:</label>
                                <input type="text" class="form-control" id="stel" name="stel" placeholder="输入电话:"/>
                            </div>
                            <div class="form-group">
